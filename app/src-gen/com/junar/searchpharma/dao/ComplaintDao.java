...
public class ComplaintDao extends AbstractDao<Complaint, Long> {
    ...
    public static class Properties {
        public final static Property Id = new Property(0, Long.class, "id",
                true, "_id");
        public final static Property Comment = new Property(1, String.class,
                "comment", false, "COMMENT");
        public final static Property Photo = new Property(2, String.class,
                "photo", false, "PHOTO");
        public final static Property Latitude = new Property(3, Float.class,
                "latitude", false, "LATITUDE");
        public final static Property Longitude = new Property(4, Float.class,
    ...
    public void readEntity(Cursor cursor, Complaint entity, int offset) {
        entity.setId(cursor.isNull(offset + 0) ? null : cursor
                .getLong(offset + 0));
        entity.setComment(cursor.isNull(offset + 1) ? null : cursor
                .getString(offset + 1));
        entity.setPhoto(cursor.isNull(offset + 2) ? null : cursor
                .getString(offset + 2));
        entity.setLatitude(cursor.isNull(offset + 3) ? null : cursor
                .getLong(offset + 3));
        entity.setLongitude(cursor.isNull(offset + 4) ? null : cursor
                .getLong(offset + 4));
    }
