...
public class PharmacyDao extends AbstractDao<Pharmacy, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Phone = new Property(7, String.class,
                "phone", false, "PHONE");
        public final static Property Latitude = new Property(8, Long.class,
                "latitude", false, "LATITUDE");
        public final static Property Longitude = new Property(9, Long.class,
                "longitude", false, "LONGITUDE");
        public final static Property Photo = new Property(10, String.class,
                "photo", false, "PHOTO");
        public final static Property Comment = new Property(11, String.class,
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE INDEX " + constraint
                + "IDX_PHARMACY_MONTH_DAY ON PHARMACY" + " (MONTH,DAY);");
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Pharmacy entity) {
        ...
        String comment = entity.getSchedule();
        if (comment != null) {
    ...
    public Pharmacy readEntity(Cursor cursor, int offset) {
        Pharmacy entity = new Pharmacy(
                ...
                cursor.isNull(offset + 8) ? null : (float) cursor
                        .getDouble(offset + 8), // latitude
                cursor.isNull(offset + 9) ? null : (float) cursor
                        .getDouble(offset + 9), // longitude
                cursor.isNull(offset + 10) ? null : cursor
                        .getString(offset + 10), // photo
                cursor.isNull(offset + 11) ? null : cursor
                        .getString(offset + 11) // comment
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Pharmacy entity, int offset) {
        ...
        entity.setPhone(cursor.isNull(offset + 7) ? null : cursor
                .getString(offset + 7));
        entity.setLatitude(cursor.isNull(offset + 8) ? null : (float) cursor
                .getDouble(offset + 8));
        entity.setLongitude(cursor.isNull(offset + 9) ? null : (float) cursor
                .getDouble(offset + 9));
        entity.setPhoto(cursor.isNull(offset + 10) ? null : cursor
                .getString(offset + 10));
        entity.setSchedule(cursor.isNull(offset + 11) ? null : cursor
                .getString(offset + 11));
    }
